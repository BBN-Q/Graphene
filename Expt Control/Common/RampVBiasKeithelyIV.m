...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function data = RampVBiasKeithleyIV(TargetVolt, RampSteps, inst)
maxVoltage = 300;
...
%%%%%%%%%%%%%%%%%%%%%       PLOT DATA     %%%%%%%%%%%%%%%%%%%%%%%%
function plot_data()
    figure(338); clf; plot(1e3*VList(1:k), 1e9*LeakCurrent(1:k), '.-'); grid on;
    xlabel('V_{bias} (mV)'); ylabel('LeakCurrent (nA)');
